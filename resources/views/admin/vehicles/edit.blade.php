                ...
                <div class="row">
                    <div class="col-md-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form form-horizontal" method="POST" action="{{ route('admin.vehicles.update', $vehicle->id) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-1 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="number_plate" class="form-control @error('number_plate') is-invalid @enderror" name="number_plate" placeholder="Vehicle Number Plate" value="{{ old('number_plate', $vehicle->number_plate) }}" required />
                                                    @error('number_plate')
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="model" class="form-control @error('model') is-invalid @enderror" name="model" placeholder="Vehicle Model" value="{{ old('model', $vehicle->model) }}" required />
                                                    @error('model')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
